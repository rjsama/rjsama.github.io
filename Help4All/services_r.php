...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	// Make the query:
	$q = 'INSERT INTO guides (name, email_address, phone_number, address, city, subject) VALUES (?, ?, ?, ?, ?,?)';

	// Prepare the statement:
	$stmt = $mysqli->prepare($q);

	// Bind the variables:
	$stmt->bind_param('sssss', $user, $email, $phone, $add, $city, $subj);
    ...
    <section id = "guides" class = "guides">
        <div class = "container">
            <div class = "section-title">
                <h2> Looking for proper guidance, register with us </h2>
                <h3> Are you a Service Provider ? <a href = "services_p.html">Click here </h3>
                <p></p>
            </div>
