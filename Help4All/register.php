        ...
        <section id = "contactform" class = "contactform">
            <div class = "container">
                ...
                <div id="contact-form-div">
                    <p style="text-align:center"><a class="query-submit-btn" href="register_regUser.php"><button style="background:none;border:none; color:#ffffff;width:70%">Regular User</button></a></p><br>
                    <p style="text-align:center"><a class="query-submit-btn" href="register_spUser.php"><button style="background:none;border:none;color:#ffffff;width:70%">Service Provider</button></a></p>
                </div>
            </div>
        </section>
